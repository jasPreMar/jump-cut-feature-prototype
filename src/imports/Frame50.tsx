import svgPaths from "./svg-mbvhuxpq3m";
import imgRectangle2 from "../assets/3b60bf79536904eac8e068b551ee0f317c3a107f.png";
    ...
    <div className="absolute bottom-px h-[524px] right-[13px] w-[815px]">
      <div className="absolute h-[456px] left-[2px] rounded-[2px] top-0 w-[813px]">
        <div className="absolute inset-0 overflow-hidden pointer-events-none rounded-[2px]">
          <img alt="" className="absolute h-[173.48%] left-[-53.44%] max-w-none top-[-8.95%] w-[157.43%]" src={imgRectangle2} />
        </div>
      </div>
      <Frame42 />
      <Frame43 />
